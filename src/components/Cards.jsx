    ...
    <section className="flex flex-col bg-white shadow-lg w-fit m-4 p-4 max-w-lg relative z-0">
      ...
      <section className="flex items-start justify-start gap-2 my-2">
        <div>
            ...
            <p className="font-semibold">{item.available_to_spend.value + item.spent.value} SGD</p>
        </div>
      ...
      className="rounded-full"
            data={[
              ...
              { value: item.available_to_spend.value, description: "5.000", color: "rgba(255,0,99)" },
            ]}
          />
       
       <div className="flex justify-between">
        <p className="flex items-center text-gray-400"><GoDotFill className="text-green-700"/>Spent</p>
        <p className="font-semibold">{item.spent.value} SGD</p>
       </div>

       <div className="flex justify-between">
        <p className="flex items-center text-gray-400"><GoDotFill className="text-pink-600"/>Available</p>
        <p className="font-semibold">{item.spent.value} SGD</p>
       </div>
      </section>
    </section>
